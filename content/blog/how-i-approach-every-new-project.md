...
4. What constraints exist (time, budget, tech, brand)
5. What questions I still can't answer

Then I send it to the client. This single habit has saved more projects than any design technique I know. It surfaces misalignments early, when they're cheap to fix.
...
At the end of every project, I do a handoff call that isn't really about the files. It's about knowledge transfer. I walk through:

- Why we made the decisions we made
- What we tried and discarded, and why
- What the next designer or developer will need to know

This sounds like extra work. It takes maybe 45 minutes. But it's the difference between work that gets used and work that gets ignored because nobody understood it.

The best projects I've done aren't the ones with the most impressive visuals. They're the ones where the client kept using what we built, years later, exactly as intended.
